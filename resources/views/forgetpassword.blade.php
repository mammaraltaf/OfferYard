<html>
    <head>
        <title>Forget Password | OfferYard</title>
        @include('cdn')
    </head>
    <body class="bg-light">
        <div class="container" style="height:100vh;">
            <div class="row m-0 d-flex justify-content-center align-items-center" style="height:100vh;">
                <div class="col-md-6 bg-white shadow rounded p-5">
                    ...
                    <p class="text-center">Please enter registered phone number to receive OTP.</p>
                    <a href="#">Resend</a>
                    <form action="/action_page.php">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Phone.." id="email">
                        </div>
