...
{{--    <link rel="icon" type="image/x-icon" href="{{asset('assets/logo/favicon.ico')}}">--}}
    <link rel="icon" type="image/png" href="{{asset('logos/service20.png')}}">
...
{{--<script>--}}
{{--    var firebaseConfig = {--}}
{{--        apiKey: "AIzaSyAwNm5zUBK3-v7z1SgfczK_uRxU1ntaBqI",--}}
{{--        authDomain: "service-api-fcm.firebaseapp.com",--}}
{{--        projectId: "service-api-fcm",--}}
{{--        storageBucket: "service-api-fcm.appspot.com",--}}
{{--        messagingSenderId: "682285771255",--}}
{{--        appId: "1:682285771255:web:3ae8a7ad40774be81b66f2",--}}
{{--        measurementId: "G-8STC7E9573"--}}
{{--    };--}}
