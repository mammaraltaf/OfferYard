<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        <!--begin::Logo-->
        <a href="#">
            <img style="vertical-align:middle; height: 55px;" alt="OfferYard" src="{{asset('images/logo.svg')}}"/>
            <span class="pl-3" style="font-size: 18px;"><b>OfferYard</b></span>
        </a>
        <!--end::Logo-->
...
{{--                    <img style="width: 18px; height: 18px; margin-right: 5px;" src="{{asset('assets/logo/logout.png')}}"> --}}
                    {{ __('Logout') }}
                </a>
            </div>
